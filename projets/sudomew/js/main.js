...
(function (global) {
  ...
  /* ---------- Notes automatiques (désactivées par défaut, réglage dans settings) ---------- */
  function isNotesOn() { return readStore(NOTES_KEY) === 'on'; }
  ...
  var i18n = {
    en: {
      ...
      reset_done: 'Grid cleared',
      daily_title: 'Daily grid',
      daily_desc: 'The same 7×7 Angry Cat grid for everyone, with a timer. A new grid every day.',
      daily_start: 'Play the daily grid',
      level_daily: 'Daily grid',
      daily_mistakes_counter: 'Bad placements: {count}',
      daily_mistakes_label: 'Bad placements',
      daily_time_label: 'Time',
      daily_solved_message: 'The daily grid is solved!',
      copy_result: 'Copy result',
      copied: 'Result copied!',
      copy_failed: 'Copy failed — select the text below',
      share_title: 'Sudomeow • Daily {size} - {day}/{month}/{year} solved!',
      share_mistakes: '-> :x: {count} bad placements',
      share_time: '-> :hourglass: {duration}',
      share_footer: 'Play yours too on -> {url}',
      notes_desc: 'Off by default. When on, impossible squares are marked with ✕ automatically; when off, cross squares out yourself with a right-click or a long press.',
      errors_counter: 'Errors: {count}',
      legend_cross: 'Right-click (or long press) a square to cross it out',
    ...
    fr: {
      ...
      reset_grid: 'Effacer la grille',
      reset_done: 'Grille effacée',
      daily_title: 'Grille du jour',
      daily_desc: 'La même grille 7×7 en Mode Chat Fâché pour tout le monde, avec un chrono. Une nouvelle grille chaque jour.',
      daily_start: 'Jouer la grille du jour',
      level_daily: 'Grille du jour',
      daily_mistakes_counter: 'Mauvais placements : {count}',
      daily_mistakes_label: 'Mauvais placements',
      daily_time_label: 'Temps',
      daily_solved_message: 'La grille du jour est résolue !',
      copy_result: 'Copier le résultat',
      copied: 'Résultat copié !',
      copy_failed: 'Copie impossible — sélectionne le texte ci-dessous',
      share_title: 'Sudomeow • Daily {size} - {day}/{month}/{year} résolu !',
      share_mistakes: '-> :x: {count} mauvais placements',
      share_time: '-> :hourglass: {duration}',
      share_footer: 'Fais le tien aussi sur -> {url}',
      notes_desc: 'Désactivé par défaut. Quand c’est activé, les cases impossibles sont barrées (✕) automatiquement ; sinon, barre-les toi-même par clic droit ou appui long.',
      errors_counter: 'Erreurs : {count}',
      legend_cross: 'Clic droit (ou appui long) sur une case pour la barrer',
    ...
    es: {
      ...
      reset_grid: 'Borrar cuadrícula',
      reset_done: 'Cuadrícula borrada',
      daily_title: 'Cuadrícula diaria',
      daily_desc: 'La misma cuadrícula 7×7 en Modo Gato Enojado para todos, con cronómetro. Una nueva cada día.',
      daily_start: 'Jugar la cuadrícula diaria',
      level_daily: 'Cuadrícula diaria',
      daily_mistakes_counter: 'Malas colocaciones: {count}',
      daily_mistakes_label: 'Malas colocaciones',
      daily_time_label: 'Tiempo',
      daily_solved_message: '¡La cuadrícula diaria está resuelta!',
      copy_result: 'Copiar resultado',
      copied: '¡Resultado copiado!',
      copy_failed: 'No se pudo copiar: selecciona el texto',
      share_title: 'Sudomeow • Daily {size} - {day}/{month}/{year} ¡resuelto!',
      share_mistakes: '-> :x: {count} malas colocaciones',
      share_time: '-> :hourglass: {duration}',
      share_footer: 'Juega el tuyo también en -> {url}',
      notes_desc: 'Desactivado por defecto. Cuando está activado, las casillas imposibles se tachan (✕) automáticamente; si no, táchalas tú con clic derecho o pulsación larga.',
      errors_counter: 'Errores: {count}',
      legend_cross: 'Clic derecho (o pulsación larga) en una casilla para tacharla',
